...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderResult(data) {
        ...
        document.getElementById('r-advice').innerHTML = data.advice.map(a => `<li>${a}</li>`).join('');
    }
    ...
    async function handleShare() {
        ...
        await ShareManager.triggerShare('palm', state.resultData, state.question);
    }
